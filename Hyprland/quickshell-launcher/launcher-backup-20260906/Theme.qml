...
QtObject {
    ...
    // ---- Papéis semânticos ----
    readonly property color background: "#242A36"     // navy-slate, meio caminho Nord/NixOS
    ...
    // ---- Transparência da janela (85% sólido / 15% transparente) ----
    readonly property real windowOpacity: 0.85
